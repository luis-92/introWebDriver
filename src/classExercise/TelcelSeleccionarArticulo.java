...
public class TelcelSeleccionarArticulo {
    ...
    public static void main(String[] args) {
        ...
        // metodos ejecutados para seguir el test case
    ...
    private static void navegarSitio(String url) {
        ...
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); // se espera 20 segundos estamos modificando la clase driver
        driver.navigate().to(url); //usamos la url que se mando al principio
    }
